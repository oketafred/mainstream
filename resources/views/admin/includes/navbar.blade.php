<header class="main-header">
  <a href="{{ route('admin_dashboard') }}" class="logo"> <!-- Logo -->
    ...
    <span class="logo-lg">
      <!--<b>Admin</b>H-admin-->
      <img src="{{ asset('assets/dist/img/logo4.png') }}" alt=""> 
      MBC
    </span>
  </a>
  <!-- Header Navbar -->
        ...
        <li class="dropdown dropdown-user admin-user">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <div class="user-image">
              <span class="text-white">Welcome, {{ Sentinel::getUser()->last_name }} {{ Sentinel::getUser()->first_name }} &nbsp;&nbsp;</span>
              <img src="{{ asset('assets/dist/img/avatar4.png') }}" class="img-circle" height="40" width="40" alt="User Image">
            </div>
          </a>
          <ul class="dropdown-menu">
            <li><a href="{{ route('admin_profile')}}"><i class="fa fa-gear"></i> My Profile</a></li>
